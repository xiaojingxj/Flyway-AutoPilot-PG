...
ALTER TABLE public.autopilot OWNER TO postgres;
...
$_$;
ALTER PROCEDURE public.insert_data(IN a integer, IN b integer) OWNER TO postgres;
...
CACHE 1
NO CYCLE;
ALTER SEQUENCE public.auto_test_tag_id_seq OWNER TO postgres;
...
ALTER TABLE public.auto_test OWNER TO postgres;
...
CREATE VIEW public.accounts_view (username, password) AS SELECT username,
    password
   FROM public.accounts;
ALTER VIEW public.accounts_view OWNER TO postgres;
